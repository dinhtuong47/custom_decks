...
function s.tgtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	and Duel.IsExistingMatchingCard(s.thfilter2,tp,LOCATION_HAND+LOCATION_MZONE,0,2,nil,tp)
	and Duel.IsExistingMatchingCard(s.thfilter3,tp,LOCATION_HAND+LOCATION_MZONE,0,1,nil,tp)
...
function s.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.SelectMatchingCard(tp,s.thfilter2,tp,LOCATION_HAND+LOCATION_MZONE,0,2,2,nil,tp)
	if #g1>0 then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
		local g2=Duel.SelectMatchingCard(tp,s.thfilter3,tp,LOCATION_HAND+LOCATION_MZONE,0,1,1,g1:GetFirst())
		g1:Merge(g2)
