...
s.listed_names={45898858,58071123,85066822,6022371,43017476}
...
function s.filter(c,e,tp)
	return c:IsCode(85066822) or c:IsCode(6022371) or c:IsCode(101010) and c:IsCanBeSpecialSummoned(e,0,tp,true,true)
end
