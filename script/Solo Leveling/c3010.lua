...
function s.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg1=aux.SelectUnselectGroup(g,e,tp,1,1,aux.dncheck,1,tp,HINTMSG_CONFIRM)
	Duel.ConfirmCards(1-tp,sg1)
	local sg2=aux.SelectUnselectGroup(g,e,tp,1,1,aux.dncheck,1,tp,HINTMSG_CONFIRM)
